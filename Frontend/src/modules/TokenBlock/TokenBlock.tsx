    ...
    if (!isUsernameLocalError) {
      try {
        const checkRes = await fetch(
          `https://api.revizemc.net/player/${username}`,
        );
        if (checkRes.ok) {
    ...
    >
      ...
      <Flex direction="column" w="full" mt="-5px">
        ...
        >
          ...
          >
            <SliderTrack bg="transparent" h={{ base: "8px", xl: "12px" }}>
              <SliderFilledTrack
                ml={{ base: "-5px", xl: "-10px" }}
                bg="white"
